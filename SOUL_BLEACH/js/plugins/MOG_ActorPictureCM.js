...
/*:
 * @plugindesc (v2.4 *) Apresenta a imagem do personagem durante a seleção de comandos.
 * @author Moghunter 
 *
 * @param -> MAIN <<<<<<<<<<<<<<<<<<<<<<<
 * @desc
 ...
 * - (BUG FIX) - Corrigido o bug de não ocultar as imagens quando a janela
 *               de messagem estiver ativa. (ATB plugin)
 *
 */
...
Scene_Battle.prototype.createSpriteset = function() {
	...
	this.createActorCMBase();
    this.createActorCM();
	this.sortMz();	
};

//==============================
// * Create Actor CM Base
//==============================
Scene_Battle.prototype.createActorCMBase = function() {
      this.actorPictureCMBase = new Actor_CMPictureBase();
      this.actorPictureCMBase.mz = 104;
      this._hudField.addChild(this.actorPictureCMBase);
};
...
//=============================================================================
// * Actor_CMPicture Base
//=============================================================================
function Actor_CMPictureBase() {
    this.initialize.apply(this, arguments);
};

Actor_CMPictureBase.prototype = Object.create(Sprite.prototype);
Actor_CMPictureBase.prototype.constructor = Actor_CMPictureBase;

//==============================
// * Initialize
//==============================
Actor_CMPictureBase.prototype.initialize = function() {
    Sprite.prototype.initialize.call(this);	
};
...
// * create Background
//==============================
Actor_CMPictureBase.prototype.createBackground = function() {
    this._background = new TilingSprite(ImageManager.loadActorpicCM("Background"));
...
// * update Visible
//==============================
Actor_CMPictureBase.prototype.updateVisible = function() {	 
    this.visible = this.visibleBase();
};

//==============================
// * visble Base
//==============================
Actor_CMPictureBase.prototype.visibleBase = function() {	 
...
// * Update
//==============================
Actor_CMPictureBase.prototype.update = function() {
	Sprite.prototype.update.call(this);
	this.updateVisible();
};
