...
/*:
 * @plugindesc (v1.7 *) Apresenta a quantidade de acertos no alvo.
 * @author Moghunter
 *
 * @param -> MAIN <<<<<<<<<<<<<<<<<<<<<<<
 * @desc
 ...
 * - (NEW) - Opção de apresentar o contador para os inimigos.
 * - (NEW) - Adicionado o efeito tremer.
 */
...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_ComboCounter');
    ...
    Moghunter.combo_posX1 = Number(Moghunter.parameters['Party X-Axis'] || 600);
