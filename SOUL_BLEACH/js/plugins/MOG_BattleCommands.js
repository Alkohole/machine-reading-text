//=============================================================================
// MOG_BattleCommands.js                      (Template - 2)
//=============================================================================

/*:
 * @plugindesc (v1.3 *) Comandos de batalhas animados por imagens.
 * @author Moghunter
 *
 * @param -> MAIN <<<<<<<<<<<<<<<<<<<<<<<
 * @desc
 ...
 * 0 - Normal     1 - Ring Command
 * @default 1
 * @type select
 * @option (0) Normal
 * @value 0
 * @option (1) Ring Command
 * @value 1
 *
 * @param Row Max
 * @parent -> MAIN <<<<<<<<<<<<<<<<<<<<<<<  
 ...
 * - (BUG FIX) - Correção da posição da janela no modo Ring Command.     
 */
...
Window_ActorCommand.prototype.com_pic_initialize = function() {
	...
	if (String(Moghunter.bcom_slide_effect) === "true" && this._com_mode_b != 1) {this._side_m = [Moghunter.bcom_slide_x, Moghunter.bcom_slide_y]};	
