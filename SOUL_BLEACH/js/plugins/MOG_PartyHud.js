...
/*:
 * @plugindesc (v1.4 *) Apresenta Huds com as condições básicas do grupo.
 * @author Moghunter
 *
 * @param -> MAIN <<<<<<<<<<<<<<<<<<<<<<<
 * @desc  
 ...
 * - PLUGIN COMMANDS
 * =============================================================================
 * Para ativar ou desativar a hud use os comandos abaixo.
 *
 * show_party_hud
 * hide_party_hud
 *
 ...
 * =============================================================================
 * - (NEW) - Plugins parameters compatíveis com RM V1.5+
 *
 */
