...
> [!IMPORTANT]
>_В последнюю неделю я начал замечать сбои при работе в качестве плагина, иногда я вижу ошибки от проверки целостности скрипта, а иногда их нет... Я добавил немного позитивного мышления(`return true;`) в проверку, вроде как помогло, но это не точно..._
><br>
>_Кто сталкивается с этой же проблемой, советую почистить кеш страницы `alkohole.github.io` и страницы на которой у вас сбоит плагин._
