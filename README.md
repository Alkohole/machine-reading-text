...
> | [!] | Объявление |
> |----|---------|
> | ⚠️ | Версия на английском языке не является хорошой, если вам нужен английский язык - воспользуйтесь **[Edge TTS](https://github.com/EdgeTTS/EdgeTTS.github.io)** или любым другим TTS. |
...
> | ⚠️ | В функции **"Слушать"** могут возникнуть фризы длинной в пару секунд. |
