# [MRT] - Машинное чтение текста ([RU](README.md)/[EN](README-en.md)/[TR](README-tr.md))
...
|  | From | To | Date |
|---|---|---|---|
| Расширение | ~~v0.5.5~~ | [**v0.5.6**_(js)_](#update-in-v056js) | 14.09.24 |
| Страница окна | ~~v0.4.2~~ | [**v0.4.3**_(web)_](#update-in-v043web) | 26.01.25 |
...
1. Зайдите в настройки ![Желтая кнопка](https://place-hold.it/15/FFCF5E/000000?text=+).
